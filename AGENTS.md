...
2. Read `specs/INDEX.md` for the full feature list, dependencies, and status
   — don't read every feature's full spec just to get oriented.
...
- Never hand-edit `internal/contract/testdata/example.json` — it is
  generated by `internal/contract/contract_test.go`. Change the struct,
  regenerate the fixture, don't edit the fixture directly.
