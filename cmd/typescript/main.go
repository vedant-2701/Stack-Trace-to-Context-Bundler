// Command stack-trace-bundler-typescript is the TypeScript/JavaScript-only
// stack-trace-bundler CLI entrypoint -- unlike cmd/all, it never
// registers --lang and always fixes the language to "typescript". For
// now (002a), it only reads and validates CLI input -- see
// specs/002a-cli-input-handling/spec.md. The real
...
func main() {
	input, verbosity, err := cli.ParseFixedLang(os.Args[1:], os.Stdin, stdinIsPiped(), "typescript")
	if err != nil {
