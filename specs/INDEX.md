...
| 006a | TypeScript/JS parser | `.cause` chain parsing, frame bucketing (own/`node_modules`/`node:internal`), runtime + runtime-version detection (node/bun/deno) | 001, 003a, 004 | specifying |
